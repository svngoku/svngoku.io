...
export default function Languages(){
 ...
 function Language({className, link , name, stars, language,resume, example}) {
    return (
        <div className={className}>
                ...
                <pre>
                    <code className={"request " + language}>
                        ...
                        <ScriptTag isHydrating={true}  type="text/javascript" src={example} /> 
                </pre>
        </div>
    )   
}
...
function star(number) {
    ...
    var content = [];
     var link = <img className="star" src={imgStar} width="35" />;
